...
import com.github.gnottero.utils.ClientOptionsManager;
...
public class TwitchProjectScarpet {
    public static void apply(Expression expression) {
        ...
        expression.addContextFunction("client_option", -1, (c, t, lv) -> {
            ...
            if (lv.size() != 3) throw new InternalExpressionException("'client_option' requires none or tree arguments");
            Value playerValue = lv.get(0);
            ServerPlayer player = EntityValue.getPlayerByValue(((CarpetContext) c).s.getServer(), playerValue);
            if (player == null)
            ...
            try {
                ...
                throw new InternalExpressionException("'" + option.toString() + "' is not a valid option.");
            }
